...
/* UART7复用器设备映射：Nano=通道0、IC=通道1、转盘=通道2。 */
#define MISSION_VISION_DEVICE_ID MULT_UART_DEVICE_0
#define MISSION_IC_DEVICE_ID     MULT_UART_DEVICE_1
#define MISSION_ZDT_DEVICE_ID    MULT_UART_DEVICE_2
