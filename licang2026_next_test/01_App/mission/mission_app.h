...
typedef enum {
    ...
    MISSION_STATE_STAIR_WAIT_VISION_END,
    ...
    MISSION_STATE_SMALL_DISC_RUNNING,
    MISSION_STATE_SMALL_DISC_WAIT_PAUSE,
    MISSION_STATE_SMALL_DISC_WAIT_ACK,
    MISSION_STATE_SMALL_DISC_WAIT_GRASP,
    MISSION_STATE_SMALL_DISC_WAIT_RETURN,
    MISSION_STATE_SMALL_DISC_WAIT_STORAGE,
    MISSION_STATE_SMALL_DISC_WAIT_VISION_RESUME,
    MISSION_STATE_SMALL_DISC_WAIT_RESUME,
